package com.rostenross.springboot.app.view.xlsx;
...
public class FacturaXlsxView extends AbstractXlsView {
    ...
    protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
            HttpServletResponse response) throws Exception {
                ...
                sheet.createRow(6).createCell(0).setCellValue(mensaje.getMessage("text.factura.factura.descripcion")+":"+factura.getDescripcion());
                sheet.createRow(7).createCell(0).setCellValue(mensaje.getMessage("text.factura.factura.fecha")+":"+factura.getCreateAt());
                ...
                header.createCell(2).setCellValue(mensaje.getMessage("text.factura.form.item.total"));
